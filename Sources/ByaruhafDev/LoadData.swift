...
class LoadData {
    class func load() {
        ...
        projects = Projects(items: [.init(name: "MockGen",
                                          ...
                                          screenShotLink: "/upload-images/mock-gen/mockgen-icon.png", videoFile: "video/mock_NetWorthy.mp4"),
                                    .init(name: "Fon Takip",
                                          code: "fundapp",
                                          ...
                                          screenShotLink: "/upload-images/fundApp/detailPage.png", videoFile: "mock_NetWorthy.mp4"),
                                    .init(name: "Wevent",
                                          code: "wevent",
                                          ...
                                          screenShotLink: "/upload-images/wevent/weventSS.jpeg", videoFile: "mock_NetWorthy.mp4"),
                                    .init(name: "Deezer Sample",
                                          ...
                                          screenShotLink: "/upload-images/deezerSample/SS1.png", videoFile: "mock_NetWorthy.mp4"),
                                    .init(name: "Github Api App with VIPER",
                                          ...
                                          screenShotLink: "/upload-images/github/SS1.png", videoFile: "mock_NetWorthy.mp4"),
        ])
