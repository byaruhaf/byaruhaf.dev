...
//  
//
//  Created by Franklin Byaruhanga on 20/07/2023.
//
        ...
        HTML(
            ...
            .body(
                ...
                .wrapper(
                    ...
                    .component(ThemeItemList(items: Array(context.allItems(sortedBy: \.date, order: .descending).filter { $0.sectionID.rawValue == ByaruhafDev.SectionID.articles.rawValue }.prefix(10)), site: context.site)
                              ),
                    .a(
                        .class("browse-all"),
                        .href("./articles"),
        ...
        HTML(
            ...
            .body(
                ...
                .class("main-wrapper"),
                    ...
                    .if(section.id.rawValue == ByaruhafDev.SectionID.projects.rawValue,
                        .wrapper(
                            .div(
                ...
                .if(section.id.rawValue == ByaruhafDev.SectionID.about.rawValue,
                    .wrapper(
...
struct ThemeFooter: Component {
    var body: Component {
        Footer {
            ...
            Paragraph {
                Link("Developed By Franklin Byaruhanga", url: "https://github.com/byaruhaf")
            }
        }
    }
}
